...
syn keyword krlOptions opacity width sticky tabColor backgroundColor color delay life divCSS pathToTabImage tabLocation topPos imageWidth imageHeight
syn keyword krlConditional if then fired else always notfired
